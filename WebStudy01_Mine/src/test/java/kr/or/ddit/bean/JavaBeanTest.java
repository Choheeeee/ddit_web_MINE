...
class JavaBeanTest {
	...
	void test() {
		...
		System.out.printf("obj1==obj2 : %b\n", obj1==obj2);	//레퍼런스 즉, 주소 비교
		System.out.printf("obj1.equals(obj2) : %b\n", obj1.equals(obj2)); //equals() : 오버라이딩 하면 상태비교를 하는 메서드가 됨. 오버라이딩 전까진 주소비교.
	}
	...
	@Test
	void test3() {
		//String은 기본형이자 참조형이고, 기본형은 모두 상수풀에 생성되고 상수풀은 가비지콜렉터가 없음.그래서 str1과 str2는 같은객체를 참조
		String str1 = "value";
		String str2 = "value";
		...
		System.out.printf("str1.equals(str3) : %b\n", str1.equals(str3)); //true - String클래스는 equals를 오버라이딩 해놓음.	
