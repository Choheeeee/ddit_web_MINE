...
class Java8TimeAPITest2 {
	...
	@Order(2)
	void test1() {
		System.out.println(LocalDateTime.now(ZoneId.of("Australia/Perth")));
		System.out.println(LocalDate.from(LocalDateTime.now(ZoneId.of("Australia/Perth"))));
		System.out.println(YearMonth.from(LocalDate.from(LocalDateTime.now(ZoneId.of("Australia/Perth")))));
		System.out.println(Year.from(YearMonth.from(LocalDate.from(LocalDateTime.now(ZoneId.of("Australia/Perth"))))));
	}
	...
	void test5() {
		...
		Locale locale = Locale.forLanguageTag(Locale.KOREA.toLanguageTag());
