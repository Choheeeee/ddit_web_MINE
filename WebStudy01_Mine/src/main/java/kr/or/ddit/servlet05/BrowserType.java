...
public enum BrowserType {
	EDG("엣지"), WHALE("웨일"), CHROME("크롬"), SAFARI("사파리"), ETC("기타");
...
//	public static final BrowserType SAFARI = new BrowserType();
//	public static final BrowserType ETC = new BrowserType();
//	
//	private static BrowserType[] instangces = {
//			EDG, WHALE, CHROME, SAFARI, ETC
//	};
//	
