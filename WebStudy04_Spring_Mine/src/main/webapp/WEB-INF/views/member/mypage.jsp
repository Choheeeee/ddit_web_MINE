...
<table class="table table-bordered">
	<tr>
		<th>프로필</th>
		<td>
<%-- 		<img alt="" src="${member.memImg }">	<!-- 자원의 data타입 그대로 갖고놀기 위해 data scheme이 필요. 이건 현재 바이트배열로 표현돼 이미지가 제대로 표현되지 않음. data scheme을 쓰고 한번 인코딩하는 과정이 필요함.--> --%>
			<img alt="" src="data:image/*;base64,${member.base64Img }">
		</td>
	</tr>
	<tr>
		<th>회원아이디</th>
