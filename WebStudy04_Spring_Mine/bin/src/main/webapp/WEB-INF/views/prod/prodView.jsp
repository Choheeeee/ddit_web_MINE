...
<%@ taglib uri="http://www.springframework.org/tags" prefix="spring" %>	<!--아래에서 스프링 EL을 쓰기 위함  -->
...
<table class="table table-bordered">
	...
	<tr>
		<th>이미지</th>
		<td>
			<%-- JSP에서 spring EL을 쓸땐  #{}대신 @를 써야한다. JSP의 defferedEL과 겹치기 때문에 / 또한 이미지의 경로가 바뀌면 appinfo.properties에서 prodPath만 변경해주면 됨 --%>
