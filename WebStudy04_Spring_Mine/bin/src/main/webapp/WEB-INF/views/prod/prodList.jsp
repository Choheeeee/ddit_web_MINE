...
<table class="table table-bordered">
	...
	<tfoot>
		<tr>
			<td colspan="6">
				<form id="searchForm" action="<c:url value='/prod/prodList.do'/>" class="border border-danger m-3 p-3">
					<h6>전송UI</h6>
				...
				<div data-pg-role="searchUI" data-pg-target="#searchForm" class="m-3 p-3 border border-primary row justify-content-center">
					<h6>입력 UI</h6>	
					<div class="col-auto">	
