 ...
 * 보호 자원에 대한 요청을 확인하고, 해당요청의 인증 여부를 결정하기 위한 필터
...
public class AuthenticationCheckFilter implements Filter {
	private Map<String, String[]> securedResources; //page, request, session, application(싱글턴객체) 중 스코프를 이용해서, 자원을 공유한다 => AuthorizationCheckFilter가 공유받아서 Map을 쓸 수 있게
